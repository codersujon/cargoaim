    ...
    <div class="row">
        ...
        <div class="col-auto info-sidebar">
            ...
            <div class="card bg-primary">
                <div class="card-body" style="background-image: url({{ asset('backend') }}/assets/images/png/arrows.svg); background-size: contain; background-repeat: no-repeat; background-position: right bottom;">
