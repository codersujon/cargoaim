...
namespace Modules\IcsEns\Http\Controllers;
...
use Modules\IcsEns\Models\IcsEns;
use Modules\IcsEns\Models\CustomsFilingEqDetails;
...
class IcsEnsController extends Controller
{
    ...
    {
        return view('icsens::euens.index');
    }
    ...
    {
        $data = IcsEns::where('row_id', $id)->first();
